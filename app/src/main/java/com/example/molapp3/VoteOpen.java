...
//        });
        ...
        editText = rootView.findViewById(R.id.et_2);
        listView = rootView.findViewById(R.id.lv_2);
        Button addButton = rootView.findViewById(R.id.btn_add2);
...
//        listView.setAdapter(adapter);
        ...
        Button galleryButton = rootView.findViewById(R.id.btn_gallery2);
        imageView1 = rootView.findViewById(R.id.iv_close2);
...
//                    text = String.valueOf(editText.getText());
        ...
        Button btn_done = rootView.findViewById(R.id.btn_done2);
        btn_done.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment newFragment = new VoteStartOpen();
